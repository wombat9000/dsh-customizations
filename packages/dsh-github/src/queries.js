...
export const PROJECT =
  'id number title url shortDescription template public closed createdAt updatedAt owner { ... on User { login } ... on Organization { login } }'
...
const ownerProject = (selection) =>
  `repositoryOwner(login:$owner) { ... on User { projectV2(number:$projectNumber) { ${selection} } } ... on Organization { projectV2(number:$projectNumber) { ${selection} } } }`
