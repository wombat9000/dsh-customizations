...
export const issue = { id: 'I_TARGET', number: 33, title: 'Target issue', url: 'https://github.com/source/example/issues/33', updatedAt: '2026-01-01T00:00:00Z', viewerCanUpdate: true, repository: { id: repository.id, nameWithOwner: repository.nameWithOwner, url: repository.url, owner: { id: 'O_SOURCE', login: 'source' } } }
export const blocker = { ...issue, id: 'I_BLOCKER', number: 34, url: 'https://github.com/blockers/other/issues/34', repository: { id: 'R_BLOCKER', nameWithOwner: 'blockers/other', url: 'https://github.com/blockers/other', owner: { id: 'O_BLOCKERS', login: 'blockers' } } }
