...
test('Jev native settings uses shared credentials and saves its model without evaluation', async ({ app }) => {
  ...
  await expect(card.getByText('Shared OpenRouter key: Not configured', { exact: true })).toBeVisible()
